...
export default function ProductDetailClient({ product, relatedProducts = [] }) {
  ...
  return (
    <>
      {/* ✅ Hero Section */}
      <Navbar />
      <section className="relative w-full h-[280px] md:h-[100vh] flex items-center justify-center overflow-hidden ">
        <div
          className="absolute inset-0   bg-center bg-cover flex flex-col items-center justify-center text-center "
      ...
      <section className="px-4 md:px-6 py-10 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 items-start">
          ...
          <div className="sticky md:top-20 md:px-10">
            <div className="w-full  md:w-[500px] bg-blue-50 h-[300px] md:h-[450px] rounded-xl shadow-xl border bg-white overflow-hidden">
              <div
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-lg p-4 md:p-6">
            <h2 className="text-xl md:text-2xl font-semibold mb-4 text-white bg-gradient-to-r from-blue-500 to-blue-600 p-3 rounded-lg shadow">
              Specifications
            </h2>
                ...
                <tbody>
                  {product.specs?.map((spec, i) => (
                    ...
                    >
                      ...
                      <td className="p-2 md:p-3 text-black text-sm md:text-lg">
                        {spec.value}
                      </td>
                    </tr>
                  ))}
            ...
            <div className="flex flex-col md:flex-row gap-4 mt-6">
              <button
                ...
                className="flex-1 cursor-pointer text-center px-4 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg shadow hover:from-blue-600 hover:to-blue-700 transition font-semibold"
              >
                Enquire Now
              </button>
              <a
                href={`https://wa.me/+919560156328?text=Hello, I am interested in ${encodeURIComponent(
                  product.name
        ...
        <div className="grid grid-cols-1 md:grid-cols-[350px_1fr] gap-6 mb-12">
          {/* Sidebar Form */}
          <div className="md:sticky md:top-24 h-fit w-full bg-green-50 text-black rounded-2xl shadow-2xl p-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <input
                ...
                required
                className="w-full p-2 md:p-3 rounded-md border focus:ring-2 focus:ring-green-500 text-sm md:text-base"
              />
              <input
                type="email"
                name="email"
              ...
              <button
                type="submit"
                className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 md:py-3 rounded-lg shadow-lg transition duration-200 text-sm md:text-base"
              >
                Submit
              </button>
          ...
          <div className="bg-gray-100 w-full rounded-xl shadow-md border">
            <h2 className="text-2xl md:text-3xl text-center font-semibold mb-5 text-white bg-gradient-to-r from-blue-500 to-blue-600 p-3 rounded-lg shadow">
              Product Description
            </h2>
